# Locators to fill – GEP2-36899, GEP2-18257, GEP2-22324, GEP2-18559
...
| GepPopups | additionalChargesNoticeContinueButton | (not in Tosca export) | US only: "The total shown may not include all applicable charges" notice after Proceed To Shipping & Billing | Filled | inner dialog with that text > `getByRole('button', { name: 'Continue', exact: true })` | live site 2026-09-25 (UK + US, GenX) |
