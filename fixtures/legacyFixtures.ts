...
import { GEP_OrderDetailsPage } from '../pages/GEP_OrderDetailsPage';
...
type GEPFixtures = {
  ...
  orderDetailsPage: GEP_OrderDetailsPage;
};

/**
 * Fixtures for the GEP_* page objects from the Gopika branch (used by GEP2-18230).
 * The other specs use the Gep* page objects in customFixtures.ts.
 *
...
export const test = base.extend<GEPFixtures>({
  ...
  orderDetailsPage: async ({ page }, use) => use(new GEP_OrderDetailsPage(page)),
});
